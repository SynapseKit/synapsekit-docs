...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v170',
      content: '🎉 <strong>v1.7.0 released</strong> — ReasoningLLM, CostQualityRouter, PromptOptimizer, FederatedRetriever, performance suite (orjson + uvloop + xxhash + Rust). <a href="/synapsekit-docs/docs/changelog">Changelog →</a> &nbsp;|&nbsp; 🚀 <strong>EvalCI</strong> — LLM quality gates on every PR, zero infra. <a href="/synapsekit-docs/docs/evalci/overview">Get started →</a>',
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          position: 'left',
          value: '<span class="navbar__version">v1.7.0</span>',
        },
        {
